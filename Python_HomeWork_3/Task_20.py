...
ноутбук
    12
"""
# Определение словарей с баллами для каждой буквы
eng_scores = {'A': 1, 'B': 3, 'C': 3, 'D': 2, 'E': 1, 'F': 4, 'G': 2, 'H': 4, 'I': 1,
              'J': 8, 'K': 5, 'L': 1, 'M': 3, 'N': 1, 'O': 1, 'P': 3, 'Q': 10, 'R': 1,
              'S': 1, 'T': 1, 'U': 1, 'V': 4, 'W': 4, 'X': 8, 'Y': 4, 'Z': 10}

rus_scores = {'А': 1, 'Б': 3, 'В': 1, 'Г': 3, 'Д': 2, 'Е': 1, 'Ё': 3, 'Ж': 5, 'З': 5, 'И': 1, 'Й': 4,
...
for i in word:
    if i in eng_alphabet:
        ...
        print("Ошибка: Слово должно содержать буквы одного языка!")
        points = 0
        break

print(f"Количество очков которое содержится в данном слове = {points}")
